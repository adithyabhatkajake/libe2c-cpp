...
if __name__ == "__main__":
    ...
    parser.add_argument('--prefix', type=str, default='e2c-setup')
    ...
    parser.add_argument('--keygen', type=str, default='./keygen')
    parser.add_argument('--tls-keygen', type=str, default='./tls-keygen')
